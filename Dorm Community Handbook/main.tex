...
\begin{document}
    ...
    % Chapters
    \input{content/chapters/01 Introductions}
    \input{content/chapters/02 Dorm Life}
    \input{content/chapters/03 Organization}
    \input{content/chapters/04 QnA}
    \input{content/chapters/05 Responsibilities}
