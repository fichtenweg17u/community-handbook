...
% Chapters
\input{content/chapters/00_quickstart}
\input{content/chapters/01_introductions}
\input{content/chapters/02_dorm_life}
\input{content/chapters/03_organization}
\input{content/chapters/04_qna}
\input{content/chapters/05_responsibilities}
\input{content/chapters/06_former_roommates}
