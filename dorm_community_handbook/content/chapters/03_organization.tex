...
\begin{table}[htp]
    ...
    \begin{tabular}{ccc}
        ...
        Microwave                         &                        &              \\ \hline
        Oven                              & Moritz S. and Danny L. & U 12 \& U 08 \\ \hline
        Cooking Surfaces                  &                        &              \\ \hline
        Pans, Pots, etc.                  &                        &              \\ \hline
        Table \& Chairs                   &                        &              \\ \hline
        Toaster, Kettle \& Sandwich Maker & Silvy Kurzendorfer     & U 17         \\ \hline
        Garbage \& Area around            & Luke C. and Paul S.    & U 09 \& U 11 \\ \hline
...
We have two fridges next to the door for groceries that need cooling. Every room has a designated space in the fridge, and then there is additional shared space. Unfortunately the fridge only has 12 dividers, which allowes for 14 compartments. We are 15 rooms though... That is why we had to come up with a different scheme than the simple \quotes{everyone get's one compartment}. As you can see in picture \ref{fig:fridge_organization} there are narrower compartments that belong to one room, and taller compartments that are shared left/right between two rooms. This is the most fair solution we could come up with...

Since counting is a bit confusing when rooms 1 and 5 are missing (yea really, they don't exist, or more precisely they are technical rooms where noone lives). That is why we labelled the compartments in the fridge. Just take a look at the left and right edge of the wall and find your number :)

\begin{figure}[htp]
    \centering
    \includegraphics[width=0.4\textwidth]{images/03_organization/fridge_labelled.jpg}
    \caption{The fridge organization.}
    \label{fig:fridge_organization}
\end{figure}

A couple of the compartments at the bottom are shared space. If you have temporarily more stuff than your compartment can fit, you may put it there, but please write in the What's App chat what and for how long you mean to put there. The same applies to the insides of the fridge doors. Feel free to put taller items there, but let others know. Once in a while we will clean out these compartments and whatever is unknown will end up in trash.

On the other side of the kitchen door you find the freezer, which follows a similar approach. Since we only have one, each compartment is shared by two rooms. So start with (2/3) at the top and count up from that (Don't forget to skip the 5!). We will label the compartments as well on the next cleaning session.
