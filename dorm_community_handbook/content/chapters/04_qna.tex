...
\section{Report Defects}
From 2026 onwards issues with your room should be reported using an online form you can find \href{https://www.my-stuwe.de/wohnen/schadensmeldung/}{$\xrightarrow{}$ here}. The QR code provided by the student council (shown in figure \ref{fig:qr-damage-report}) points to the same link.

\begin{figure}[htp]
    \centering
    \includegraphics[width=.15\textwidth]{images/04_qna/damage_report.png}
    \caption{A QR code to the damage report form, provided by the student council.}
    \label{fig:qr-damage-report}
\end{figure}

Alternatively it is always possible to just talk to our caretaker \href{https://www.my-stuwe.de/team/kanellos-panagopoulos/}{$\xrightarrow{}$ Mr. Panagopoulos}. His office is in \href{https://maps.app.goo.gl/9XaMCXBBQvgLqDJv7}{$\xrightarrow{}$ Fichtenweg 7}, just turn right immediately after entering through the front door.

\section{StuWe Account}

As of march 2026 the Studierendenwerk added an account management page to their portal \href{https://www.my-stuwe.de/login-mieterkonto/}{$\xrightarrow{}$~here}. It allows to register a phone number, change the email, etc. The same site also allows uploading files to send them to the office, e.g. if they are too big for an email.